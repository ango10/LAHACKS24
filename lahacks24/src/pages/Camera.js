...
const Camera = () => {
    ...
    const handleInputChange = (event) => {
        ...
        const ingredientList = inputValue.split(',').map((ingredient) => ingredient.trim());
    ...
    <div className='absolute'>
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                <a href="/Camera" class="block py-2 px-3 text-gray-900 rounded md:border-0 md:p-0 dark:text-white :bg-transparent">Enter Ingredients</a>
                </li>
                <li>
        ...
        <div className="flex justify-center items-center h-screen">
            <div>
            <h1 className='text-center pb-3'>Enter Ingredients Here</h1>
            <form className='w-96'>   
